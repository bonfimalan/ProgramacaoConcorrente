  ...
  public void run(){
    try{
      while(true){
        ...
        moverEixoX(490-29);//move o onibus ate a posicao passada
        verificaTunel2();//verifica se o tunel esta liberado, se nao ele para o onibus
        alteraEstadoTunel2();//altera o estado do tunel, nesse caso ele fica como ocupado
        controlador.setVisivelBandeiraEntradaAzul2(true);//levanta a "bandeira"
        moverPeloTunel(470-29);//faz as animacoes das curvas e move pelo tunel
        alteraEstadoTunel2();//altera o estado do tunel, nesse caso ele fica como desocupado
        controlador.setVisivelBandeiraEntradaAzul2(false);//abaixa a "bandeira"
        
        //mesma sequencia de comandos que a anterior, mas em relacao ao tunel 1
        moverEixoX(250-29);
        verificaTunel1();
        alteraEstadoTunel1();
        controlador.setVisivelBandeiraEntradaAzul1(true);
        moverPeloTunel(230-29);
        alteraEstadoTunel1();
        controlador.setVisivelBandeiraEntradaAzul1(false);

        moverEixoX(-58);//move o onibus ate depois do fim da pista

        posicaoX = 600;
        Platform.runLater( () -> onibus.setX(600));//faz o onibus voltar para a posicao original
      }//fim while
    }//fim try
